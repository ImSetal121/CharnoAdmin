package org.charno.commonwebsocket.handler;

import com.fasterxml.jackson.databind.ObjectMapper;
import lombok.extern.slf4j.Slf4j;
import org.charno.commonwebsocket.manager.WebSocketConnectionManager;
import org.charno.commonwebsocket.model.WebSocketMessageType;
...
public abstract class BaseWebSocketHandler implements WebSocketHandler {
    ...
    private Mono<Void> handleMessage(WebSocketSession session, String userId, org.springframework.web.reactive.socket.WebSocketMessage message) {
        ...
        try {
            // 解析消息
            org.charno.commonwebsocket.model.WebSocketMessage wsMessage = 
                    objectMapper.readValue(payload, org.charno.commonwebsocket.model.WebSocketMessage.class);
     ...
     * 处理订阅消息
     */
    private Mono<Void> handleSubscribeMessage(WebSocketSession session, String userId, org.charno.commonwebsocket.model.WebSocketMessage message) {
     ...
     * 处理取消订阅消息
     */
    private Mono<Void> handleUnsubscribeMessage(String userId, org.charno.commonwebsocket.model.WebSocketMessage message) {
        String subscriptionKey = message.getKey();
        if (subscriptionKey == null || subscriptionKey.isEmpty()) {
    ...
    private Mono<Void> handlePing(WebSocketSession session) {
        ...
        org.charno.commonwebsocket.model.WebSocketMessage pongMessage = 
                org.charno.commonwebsocket.model.WebSocketMessage.builder()
     ...
     */
    protected Mono<Void> handleBusinessMessage(WebSocketSession session, String userId, org.charno.commonwebsocket.model.WebSocketMessage message) {
     ...
     * 发送消息
     */
    protected Mono<Void> sendMessage(WebSocketSession session, org.charno.commonwebsocket.model.WebSocketMessage message) {
        try {
    ...
    protected Mono<Void> sendSuccess(WebSocketSession session, String message) {
        org.charno.commonwebsocket.model.WebSocketMessage successMessage = 
                org.charno.commonwebsocket.model.WebSocketMessage.builder()
    ...
    protected Mono<Void> sendError(WebSocketSession session, String error) {
        org.charno.commonwebsocket.model.WebSocketMessage errorMessage = 
                org.charno.commonwebsocket.model.WebSocketMessage.builder()
